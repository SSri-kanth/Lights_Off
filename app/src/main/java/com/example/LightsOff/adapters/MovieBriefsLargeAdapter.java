package com.example.LightsOff.adapters;
...
import com.example.LightsOff.activities.MovieDetailActivity;
...
public class MovieBriefsLargeAdapter extends RecyclerView.Adapter<MovieBriefsLargeAdapter.MovieViewHolder> {
    ...
    public class MovieViewHolder extends RecyclerView.ViewHolder {
        ...
        public MovieViewHolder(View itemView) {
            ...
            movieGenreTextView = itemView.findViewById(R.id.text_view_genre_show_card);
            movieFavImageButton = itemView.findViewById(R.id.image_button_fav_show_card);

            imageLayout.getLayoutParams().width = (mContext.getResources().getDisplayMetrics().widthPixels);
            imageLayout.getLayoutParams().height = ((mContext.getResources().getDisplayMetrics().widthPixels) / 2);
